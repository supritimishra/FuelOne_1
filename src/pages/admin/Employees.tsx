                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="number"
                      value={row.salary}
                      onChange={(e) => updateRow(row.tempId, 'salary', e.target.value === '' ? '' : parseFloat(e.target.value))}
                      className="bg-white border-blue-200 focus:border-blue-500 mt-0.5"
                      placeholder="0"
                    />
                  </div>
                ...
                <div className="bg-blue-100 p-3 rounded-md">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor={`has_pf_${row.tempId}`} className="text-xs text-blue-900 font-medium cursor-pointer">Provident Fund</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                      ...
                      />
                      <Label htmlFor={`has_income_tax_${row.tempId}`} className="text-xs text-blue-900 font-medium cursor-pointer">Income Tax</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                      ...
                      />
                      <Label htmlFor={`has_esi_${row.tempId}`} className="text-xs text-blue-900 font-medium cursor-pointer">Employees State Insurance</Label>
                    </div>
                  </div>
                </div>
              </div>
