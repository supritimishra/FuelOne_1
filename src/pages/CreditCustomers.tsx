              ...
              <TableBody>
                {filteredCustomers.map((item, i) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      <div className="space-y-0.5">
                        <div>₹{item.opening_balance || 0}</div>
                    ...
                    <TableCell>
                      <div className="space-y-0.5">
                        <div className="font-medium">₹{item.credit_limit || 0}</div>
                    ...
                    <TableCell>
                      <Button 
                        variant="outline" 
                        size="sm" 
                        className="h-8 text-xs flex items-center gap-1 bg-blue-50 hover:bg-blue-100 border-blue-300"
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    ...
                    <span className="ml-2">₹{viewingCustomer.credit_limit || 0}</span>
                  </div>
                  <div>
                    <span className="font-semibold text-gray-700">Advance Amount:</span>
                    <span className="ml-2">₹{viewingCustomer.advance_no || 0}</span>
                  </div>
                  <div>
                    <span className="font-semibold text-gray-700">Opening Balance:</span>
                    <span className="ml-2">₹{viewingCustomer.opening_balance || 0}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="ml-2">₹{viewingCustomer.discount_amount || 0}</span>
                  </div>
                  <div>
              ...
              {viewingCustomer.penalty_interest && (
                <div className="bg-red-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-red-900 mb-3 flex items-center gap-2">
                    <span className="text-lg">⚠️</span> Penalty & Interest Information
                  </h3>
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
