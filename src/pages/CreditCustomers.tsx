        ...
        <CardContent className="p-6 bg-blue-50">
          <form onSubmit={form.handleSubmit(onSubmit, (errors) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                <Label htmlFor="opening_balance" className="text-blue-900 font-semibold">Opening Balance (Γé╣)</Label>
                <Input
                  id="opening_balance"
                  type="number"
              ...
              <div className="md:col-span-2 flex justify-end items-center h-full pt-6">
                ...
                >
                  <div className={`w-4 h-4 border border-blue-900 rounded-sm flex items-center justify-center ${form.watch("penalty_interest") ? "bg-blue-900" : ""}`}>
                    {form.watch("penalty_interest") && <span className="text-white text-xs">Γ£ô</span>}
                  </div>
                  Penalty Interest
                </Button>
              </div>
