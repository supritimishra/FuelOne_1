...
--> statement-breakpoint
ALTER TABLE "user_feature_access" ADD CONSTRAINT "user_feature_access_feature_id_feature_permissions_id_fk" FOREIGN KEY ("feature_id") REFERENCES "public"."feature_permissions"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
CREATE UNIQUE INDEX "user_feature_access_user_feature_idx" ON "user_feature_access" USING btree ("user_id","feature_id");
--> statement-breakpoint
INSERT INTO "feature_permissions" ("feature_key", "label", "feature_group", "description", "default_enabled") VALUES
