...
async function runTokenBlacklistMigration() {
  console.log('🚀 Running token blacklist migration on master database...\n');

  try {
    // Read migration file
    const migrationPath = path.resolve(process.cwd(), 'migrations/20250103_add_token_blacklist.sql');
    ...
    console.log('✅ invalidated_tokens table created in master database');
